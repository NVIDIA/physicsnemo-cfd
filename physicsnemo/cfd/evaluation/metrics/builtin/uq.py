...
# EVERY UQ method (a closed-form GP posterior's marginals OR the sampling across-pass spread), so
# the same caveat applies to all of them — it is NOT specific to closed-form models: treating
# cells as independent is exact for spatially-uncorrelated uncertainty but a lower bound for
